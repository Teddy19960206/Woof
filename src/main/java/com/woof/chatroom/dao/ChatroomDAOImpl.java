...
public class ChatroomDAOImpl implements ChatroomDAO {
	...
	@Override
	public int insert(Chatroom chatroomVO) {
		return (Integer) getSession().save(chatroomVO);
	}

	@Override
	public int update(Chatroom chatroomVO) {
		try {
			getSession().update(chatroomVO);
			return 1;
		} catch (Exception e) {
			return -1;
		}
	...
	public int delete(Integer roomNo) {
		Chatroom chatroomVO = getSession().get(Chatroom.class, roomNo);
		if (chatroomVO != null) {
			getSession().delete(chatroomVO);
			return 1;
		} else {
			return -1;
		}
	...
	public List<Chatroom> getAll() {
		return getSession().createQuery("FROM ChatRoomVO", Chatroom.class).list();
	}

	@Override
	public Chatroom getById(Integer roomNO) {
		// TODO Auto-generated method stub
		return null;
	}
}
