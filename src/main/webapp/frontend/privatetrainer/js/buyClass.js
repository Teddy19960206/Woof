...
classAcount.addEventListener("input" , function (){
    actualAmount.value = price.value*classAcount.value;
})

smmpCount.addEventListener("input" , function (){
    actualAmount.value = price.value*classAcount.value - smmpCount.value;
})
