...
<body>
	...
	<form method="POST" ACTION="${pageContext.request.contextPath}/member">
		...
		<div style="text-align: center;">
			<label for="Member">Select Member:</label> <select name="Member"
				id="selectMember">
...
<!-- <style> -->
/* table#table-1 { */ /* width: 450px; */ /* background-color: #CCCCFF;
*/ /* margin-top: 5px; */ /* margin-bottom: 10px; */ /* border: 3px
ridge Gray; */ /* height: 80px; */ /* text-align: center; */ /* } */ /*
table#table-1 h4 { */ /* color: red; */ /* display: block; */ /*
margin-bottom: 1px; */ /* } */ /* h4 { */ /* color: blue; */ /* display:
inline; */ /* } */
<!-- </style> -->
