...
public class ReturnListVO implements Serializable {
    ...
    @Column(name="RE_STATUS")		//退貨狀態 0:待處理 1:已接受 2:已拒絕
	private Integer reStatus;

    @Column(name="RE_DATE")			//退貨申請日期
	private Timestamp reDate;

    @Column(name="PROC_DATE")		//退貨處理日期
	private Timestamp procDate;

    @Column(name="REPAY_STATUS")	//退款狀態 0:未退款 1:退款中 2:已退款
	private Integer repayStatus;

    @Column(name="RED_AMOUNT")		//退貨數量
